...
actual_2023 = int(total_row['Year 2023'].values[0].replace(',', ''))
...
print(f"Linear Regression - Prediction: {predicted_2023_linear[0]:.0f}, MSE: {mse_linear:.2f}, MAE: {mae_linear:.2f}")
...
print(f"SVM - Prediction: {predicted_2023_svm[0]:.0f}, MSE: {mse_svm:.2f}, MAE: {mae_svm:.2f}")
...
print(f"Random Forest - Prediction: {predicted_2023_rf[0]:.0f}, MSE: {mse_rf:.2f}, MAE: {mae_rf:.2f}")
...
print(f"MLP - Prediction: {predicted_2023_mlp:.0f}, MSE: {mse_mlp:.2f}, MAE: {mae_mlp:.2f}")
...
print(f"LSTM - Prediction: {predicted_2023_lstm:.0f}, MSE: {mse_lstm:.2f}, MAE: {mae_lstm:.2f}")
